  ...
  return (
    <Box component="div" className="program-card" m={3} pb={1}>
      <Box className="program-img">
        {props.isNew && <Box position="absolute" left={0} top="2%" component="span" borderRadius="0 25px 25px 0px" p={1} pr={2} bgcolor="#e42525" color="white" fontWeight="bold" fontSize="14px" mt={3}>
          New
        </Box>}
      </Box>
